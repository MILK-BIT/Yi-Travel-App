# 奕游安卓App
## 系统要求
安装运行10.0以上版本Android的Android手机/平板
## UI预览
<div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center;">
  <img src="https://github.com/MILK-BIT/Yi-Travel-App/blob/main/image/图片1.png" width="200" height="400" alt="图片1" />
  <img src="https://github.com/MILK-BIT/Yi-Travel-App/blob/main/image/图片2.png" width="200" height="400" alt="图片2" />
...
## 支持功能
- 个人偏好设置——预填并保存用户的偏好
- 旅行规划——调用LLM根据用户输入地点与游览时间进行按天数划分的旅行规划并在地图上标明涉及地点位置
- 喜好的行程规划保存与修改——用户可以自己保存喜欢的旅行规划并可以进行手动修改
- 旅行规划分享——用户可以将保存后的行程规划分享给其他软件如微信、备忘录等
